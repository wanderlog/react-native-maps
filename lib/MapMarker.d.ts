...
import { Animated, ViewProps, ImageURISource, ImageRequireSource, View } from 'react-native';
...
declare type OmittedProps = Omit<Props, 'stopPropagation'>;
declare type NativeProps = Modify<OmittedProps, {
    icon?: string;
    image?: Props['image'] | string;
}> & {
    ref: React.RefObject<View>;
};
export declare class MapMarker extends React.Component<Props> {
    ...
    redraw(): void;
    _getHandle(): number | null;
    _runCommand(name: NativeCommandName, args: any[]): void;
    render(): JSX.Element;
}
declare const _default: typeof MapMarker;
export default _default;
declare type NativeCommandName = 'showCallout' | 'hideCallout' | 'redrawCallout' | 'animateMarkerToCoordinate' | 'redraw';
